 ...
 insert  into tblOffice(officeCode,city,phone,addressLine1,addressLine2,state,country,postalCode,territory) values 
...
('4','Paris','+33 14 723 4404','43 Rue Jouffroy','abbans',NULL,'France','75017','EMEA'),
...
insert  into tblEmployees(employeeNumber,lastName,firstName,extension,email,ofcCode,reportsTo,jobTitle) values 
...
insert  into tblCustomers(customerNumber,customerName,contactLastName,ContactFirstName,phone,addressLine1,addressLine2,city,state,postalCode,country,salesRepemployeeNumber,creditLimit) values 
...
insert  into tblProducts(productCode,productName,prodLine,productScale,productVandor,productDescription,quantityInStock,buyPrice,msrp) values 
